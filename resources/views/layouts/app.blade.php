...
<head>
    ...
    <link rel="icon" href="{{asset('images/logo/favicon.png')}}?v1.1" type="image/x-icon">
...
fbq('init', '1591339188632110');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1591339188632110&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
    ...
    <link rel="stylesheet" href="{{ asset('css/style.css?v1.2') }}">
